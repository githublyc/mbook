...
import (
	...
	"mbook/webook/api/proto/gen/reward/v1"
	"mbook/webook/reward/domain"
...
func (r *RewardServiceServer) PreReward(ctx context.Context,
	request *rewardv1.PreRewardRequest) (*rewardv1.PreRewardResponse, error) {
