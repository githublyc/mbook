...
func (d *DoubleWritePool) BeginTx(ctx context.Context,
	opts *sql.TxOptions) (gorm.ConnPool, error) {
	...
	case PatternSrcFirst:
		...
		return &DoubleWriteTx{src: src, dst: dst, pattern: pattern, l: d.l}, nil
	case PatternDstOnly:
		dst, err := d.dst.(gorm.TxBeginner).BeginTx(ctx, opts)
...
func (d *DoubleWritePool) PrepareContext(ctx context.Context,
...
func (d *DoubleWritePool) ExecContext(ctx context.Context, query string,
...
func (d *DoubleWritePool) QueryContext(ctx context.Context, query string,
...
func (d *DoubleWritePool) QueryRowContext(ctx context.Context, query string,
...
func (d *DoubleWriteTx) PrepareContext(ctx context.Context,
	query string) (*sql.Stmt, error) {
	// 这个方法没办法改写
	// 我没办法返回一个双写的  sql.Stmt
	panic("双写模式写不支持")
...
func (d *DoubleWriteTx) ExecContext(ctx context.Context, query string,
	args ...interface{}) (sql.Result, error) {
	switch d.pattern {
	case PatternSrcOnly:
		return d.src.ExecContext(ctx, query, args...)
...
func (d *DoubleWriteTx) QueryContext(ctx context.Context, query string,
	args ...interface{}) (*sql.Rows, error) {
	switch d.pattern {
	case PatternSrcOnly, PatternSrcFirst:
		return d.src.QueryContext(ctx, query, args...)
...
func (d *DoubleWriteTx) QueryRowContext(ctx context.Context, query string,
	args ...interface{}) *sql.Row {
	// 这样你没有带上错误信息
	//return &sql.Row{}
	panic(errUnknownPattern)
