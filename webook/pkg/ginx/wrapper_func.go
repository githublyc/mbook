...
// WrapBodyAndClaims bizFn 就是我的业务逻辑
func WrapBodyAndClaims[Req any, Claims any](bizFn func(
	ctx *gin.Context, req Req, uc Claims) (Result, error)) gin.HandlerFunc {
...
func WrapBody[Req any](bizFn func(
	ctx *gin.Context, req Req) (Result, error)) gin.HandlerFunc {
	return func(ctx *gin.Context) {
		var req Req
		if err := ctx.Bind(&req); err != nil {
			L.Error("输入错误", logger.Error(err))
